package com.example.demoapp.view.onboarding.welcomescreen
...
class WelcomeScreen : Fragment() {
    ...
    override fun onCreateView(
        ...
        val button = view.findViewById<Button>(R.id.primaryButton)
        button.setOnClickListener {
            parentFragmentManager.beginTransaction()
                .replace(R.id.fragment_container, LetsYouIn())
                .addToBackStack(null)
                .commit()
        }
